# flexai/executor/boolean_executor.py
...
class BooleanExecutionError(RuntimeError):
    pass


def subtract_cutter_with_blender(
    target_path: Path,
    cutter_path: Path,
    output_path: Path,
    blender_path: str | None = None,
) -> BlenderRunResult:
    script_path = Path(__file__).resolve().parent / "scripts" / "boolean_subtract.py"
